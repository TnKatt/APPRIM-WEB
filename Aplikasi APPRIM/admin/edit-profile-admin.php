...
$defaultPhoto = $uploadDir . 'foto_default.svg';  // Foto default
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['simpan'])) {
        ...
        // Redirect ke halaman profile-admin.php setelah perubahan disimpan
    ...
    if (isset($_POST['batal'])) {
        ...
        // Arahkan kembali ke halaman profile-admin.php tanpa ada perubahan
