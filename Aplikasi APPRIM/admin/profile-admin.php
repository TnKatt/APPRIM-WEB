    ...
    <body>
        <div class="container">
            <div>
                ...
                <?php else: ?>
                    <img src="../images/foto_user/foto_default.svg" alt="foto_default" class="profil-img">
                <?php endif; ?>
            ...
            <div class="button-group">
                <a href="../admin/ganti-password-admin.php"><ganti-pw-btn type='button' class="btn">Ganti Password</ganti-pw-btn></a>
                <a href="../admin/edit-profile-admin.php"><button type='button' class="btn">Edit Profile</button></a>
            </div>

            <div class="back-to-home">
                <hr/>
                    <span><a href='../admin/home-admin.php'>Back to Home</a></span>
                <hr/>   
            </div>
